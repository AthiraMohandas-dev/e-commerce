...
const middlewareProductsRequest = __importStar(require("../middleware/product_request"));
...
productsApiRouter
    ...
    .get(middlewareProductsRequest.validateProductSearchQuery(), products_controller_1.default.getProduct);
